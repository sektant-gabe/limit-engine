...
// configuration step. It creates a namespace called `limit_engine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", limit_engine::cmake::project_name, limit_engine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", limit_engine::cmake::project_version);
      return EXIT_SUCCESS;
    }
